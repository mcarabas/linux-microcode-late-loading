...
Source1002: config-aarch64
Source1003: config-aarch64-debug
...
# TEMPORARY HACK: use the debuginfo in the build tree.
...
%{_sbindir}/new-kernel-pkg --package kernel%{?-v:-%{-v*}} --install --make-default %{KVERREL}%{!-u:%{?-v:.%{-v*}}} || exit $?\
%{nil}
